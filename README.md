...
| HTML | meta, JSON-LD, data-ai*, `<!-- -->` comments naming an AI tool | Strip tags/attrs/comments |
| Markdown | YAML frontmatter AI keys, `<!-- -->` comments naming an AI tool (outside code fences) | Drop keys and comments + Layer A body |
